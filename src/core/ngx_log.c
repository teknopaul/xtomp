...
static const char *debug_levels[] = {
    ...
    "debug_http", "debug_mail", "debug_stream", "debug_xtomp"
};
...
#endif
{
    ...
    (void) ngx_sprintf(msg, "xtomp: [%V] ", &err_levels[level]);
...
#else
        ngx_conf_log_error(NGX_LOG_EMERG, cf, 0,
                           "xtomp was built without debug support");
        return NGX_CONF_ERROR;
#endif
